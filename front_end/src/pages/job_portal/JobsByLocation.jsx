...
import { getJobsByLocation, clearJobsList } from '../../redux_store/JobReduxSlice';
import { Link } from 'react-router-dom';

const JobsByLocationPage = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto my-8">
      <h1 className="text-2xl font-bold text-[#14532D] mb-6">Find Jobs by Location</h1>
      ...
      {jobs.length > 0 ? (
        ...
        <div className="text-center p-8 text-gray-500">
          {location ? 'No jobs found in this location' : 'Enter a location to search for jobs'}
        </div>
      )}
